...
#### <font color="#ff0000">凑微分</font>
- $$\int f[g(x)]g'(x) dx = \int f[g(x)] dg(x) = \int f(u) du$$
#### <font color="#ff0000">换元法</font>
- 一般换元法
...
- 倒代换
	- $t = \frac{1}{x}$
#### <font color="#ff0000">分部积分</font>
- $\int u dv = uv - \int v du$
- 递归法:$\ I_{n} = I_{n-1} + f(x)$
- 组合积分法
#### <font color="#ff0000">有理函数积分</font>
...
## <font color="#00b050">反常积分 (广义积分)</font>
- 定义
	- 积分区间无界 (无穷区间: 奇点)
	- 积分函数无界 (无界函数: 瑕点)
- 敛散性判别
...
## <font color="#00b050">一元函数积分学应用</font>
### <font color="#f79646">面积</font>
...
### <font color="#f79646">平均值</font>
- $$\overline{y}=\dfrac{1}{b-a}\int_{a}^{b}f(x)dx$$

### <font color="#f79646">形心</font>
- $$\left\lbrace
\begin{array}{l}

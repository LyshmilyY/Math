...
## <font color="#ff0000">常数项级数</font>

### <font color="#00b050">概念</font>
...
#### <font color="#00b050">比较判别法极限形式</font>
...
#### <font color="#00b050">比值判别法(达朗贝尔判别法)</font>
...
### <font color="#f79646">交错级数</font>: $\sum\limits_{n=1}^{+\infty}(-1)^{n-1}u_{n}(u_{n} > 0)$
- $u_{n}$ 单调不增
- $\lim\limits_{n \to +\infty} u_{n} = 0$
- 交错级数 $\sum\limits_{n=1}^{+\infty}(-1)^{n-1} u_{n}$ 收敛

### <font color="#f79646">一般项级数(绝对值判别法)</font>
...
### <font color="#7030a0">常见级数收敛判别</font>
...
## <font color="#ff0000">函数项级数</font>
### <font color="#00b050">函数项级数定义</font>
...
### <font color="#00b050">幂级数</font>

#### <font color="#f79646">幂级数定义</font>
...
#### <font color="#f79646">收敛点和发散点</font>
...
### <font color="#7030a0">函数展开成幂级数</font>
...
## <font color="#ff0000">傅里叶级数</font>

### <font color="#00b050">傅里叶级数定义</font>
...
### <font color="#00b050">狄利克雷收敛定理</font>
...
### <font color="#00b050">正弦级数和余弦级数</font>
...
### <font color="#00b050">周期奇延拓和周期偶延拓</font>

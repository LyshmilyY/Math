...
\begin{example}[][Exam: 27.1.8]
	求$\lim\limits_{n\to\infty}\left[\sqrt{1+2+\cdots+n}-\sqrt{1+2+\cdots+(n-1)}\right]$
\end{example}
...
\myspace{1}
\textcolor{orange}{\textbf{January 3}}

\begin{example}[][Exam: 27.1.10]
	 求极限 $\lim\limits_{x\to 0}\left(\dfrac{2+e^{\frac{1}{x}}}{1+e^{\frac{4}{x}}}+\dfrac{\sin x}{|x|}\right)$
\end{example}
...
\myspace{1}
\textcolor{orange}{\textbf{January 4}}

\begin{example}[][Exam: 27.1.12]
	求极限 $\lim\limits_{x\to 0}\dfrac{\sqrt{1+\tan x}-\sqrt{1+\sin x}}{x(1-\cos x)}$
\end{example}
...
\begin{example}[][Exam: 27.1.15]
	求极限 $\lim\limits_{x\to 0}\dfrac{\arcsin x-\arctan x}{\sin x-\tan x}$
\end{example}
...
\begin{example}[][Exam: 27.1.16]
	求极限 $\lim\limits_{x\to 0}\dfrac{\ln\dfrac{x}{\ln(1+x)}}{x}$
\end{example}
...
\begin{example}[][Exam: 27.1.17]
	求极限 $\lim\limits_{x\to +\infty}\dfrac{e^{x}}{(1+\dfrac{1}{x})^{x^{2}}}$
\end{example}
...
\myspace{1}
\textcolor{orange}{\textbf{January 7}}

\begin{example}[][Exam: 27.1.18]
	求极限 $\lim\limits_{x\to 0}\dfrac{\cos x-\cos(\sin x)}{x^{4}}$
\end{example}
...
\begin{example}[][Exam: 27.1.19]
	求极限 $\lim\limits_{x\to +\infty}x^{2}\left[\arctan(x+1)-\arctan x\right]$
\end{example}
...
\begin{example}[][Exam: 27.2.1]
	求极限 $\lim\limits_{n\to \infty}n^{2}\left[\arctan\dfrac{a}{n}-\arctan \dfrac{a}{n+1}\right]$
\end{example}
...
\begin{example}[][Exam: 27.2.3]
	求极限 $\lim\limits_{x\to 0}\left[\dfrac{1}{\ln(1+x^{2})}-\dfrac{1}{\ln(1+\tan^{2}x)}\right]$
\end{example}
...
\begin{example}[][Exam: 27.2.4]
	求极限 $\lim\limits_{x\to 0}\left[\dfrac{1}{\ln(1+x^{2})}-\dfrac{1}{\sin^{2}x}\right]$
\end{example}
...
\begin{example}[][Exam: 27.2.5]
	求极限 $\lim\limits_{x\to 0}\left(x+2^{x}\right)^{\frac{2}{x}}$
\end{example}
...
\begin{example}[][Exam: 27.2.8]
	求极限 $\lim\limits_{x\to 0}\left(\dfrac{\arctan x}{x}\right)^{\frac{1}{1-\cos x}}$
\end{example}
...
\begin{example}[][Exam: 27.2.9]
	求极限 $\lim\limits_{n\to \infty}\left(n\tan\frac{1}{n}\right)^{n^{2}}$
\end{example}
...
\begin{example}[][Exam: 27.2.10]
	求极限 $\lim\limits_{n\to \infty}\tan^{n}\left( \dfrac{\pi}{4}+\dfrac{1}{n}\right)$
\end{example}
...
\myspace{1}
\textcolor{blue}{\textbf{January 13}}

\begin{example}[][Exam: 27.2.11]
	求极限 $\lim\limits_{x\to 0}\left( \dfrac{\ln(1+x)}{x}\right)^{\frac{1}{e^{x}-1}}$
\end{example}
...
\begin{example}[][Exam: 27.2.12]
	求极限 $\lim\limits_{x\to 0}\left( \dfrac{(1+x)^{\frac{1}{x}}}{e}\right)^{\frac{1}{x}}$
\end{example}
...
\begin{example}[][Exam: 27.2.14]
	 求极限 $\lim\limits_{x\to \frac{\pi}{4}}\left( \tan x\right) ^{\frac{1}{\cos x-\sin x}}$
\end{example}
...
\begin{example}[][Exam: 27.3.1]
	求极限 $\lim\limits_{x\to 0}\left(\dfrac{(e^{x}+e^{2x}+\cdots +e^{nx})}{n} \right)^{\frac{1}{x}} $
\end{example}
...
\begin{example}[][Exam: 27.3.2]
	求极限 $\lim\limits_{x\to \infty}\left(\dfrac{x^{n}}{(x+1)(x+2)\cdots(x+n)} \right)^{x} $
\myspace{1}
\end{example}
...
\myspace{1}
\textcolor{cyan}{\textbf{January 16}}

\begin{example}[][Exam: 27.3.3]
	求极限 $\lim\limits_{x\to \infty}\left(\sin\frac{1}{x}+\cos\frac{1}{x} \right)^{x} $
\end{example}
...
\begin{example}[][Exam:27.3.4]
	求极限 $\lim\limits_{n\to \infty}n\left[e\left(1+\dfrac{1}{n} \right)^{-n}-1 \right]$
\end{example}
...
\begin{example}[][Exam: 27.3.6]
	求极限 $\lim\limits_{x\to 0}\dfrac{(1-\sqrt{\cos x})(1-\sqrt[3]{\cos x})\cdots(1-\sqrt[n]{\cos x})}{(1-\cos x)^{n-1}}$
\end{example}
...
\begin{example}[][Exam: 27.3.7]
	求极限 $\lim\limits_{x\to 0}\dfrac{\ln(\sin^{2}x+e^{x})-x}{\ln(x^{2}+e^{2x})-2x}$
\end{example}
...
\begin{example}[][Exam: 27.3.8]
	已知极限 $\lim\limits_{x\to 0}\dfrac{x-\tan x}{x^{k}}=c$,其中 $k,c$ 为常数,且 $c\neq 0$,求 $k,c$
\end{example}
...
\begin{example}[][Exam: 27.3.9]
	若 $\lim\limits_{x\to 0}\left(\dfrac{\sin x^{4}}{x^{4}}-\dfrac{f(x)}{x^{3}}\right)=2$,则当 $x\to 0$ 时,$f(x)$ 是 $x$ 的:
\begin{itemize}
	\item A. 等价无穷小
	\item B. 同阶但非等价无穷小
	\item C. 高阶无穷小

...
\begin{example}[][Exam: 31.3.4]
	$$\int_{0}^{\frac{\pi}{4}}\dfrac{x}{\cos(\frac{\pi}{4}-x)\cos x}dx$$
\end{example}
...
\textcolor{cyan}{May 17}

\begin{example}[][Exam: 31.3.5]
	$$\iint\limits_{D}\dfrac{1}{xy}dxdy, D=\{(r,\theta)|\dfrac{\cos \theta}{4}\leq r\leq \dfrac{\cos\theta}{2}, \dfrac{\sin \theta}{4}\leq r\leq \dfrac{\sin\theta}{2}\}$$
\end{example}
